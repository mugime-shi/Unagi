...
export default function App() {
  ...
  const lgbmForecast =
    day === "tomorrow" && retrospective?.models?.lgbm
      ? {
  ...
  const {
    ...
    error: reviewError,
  } = useDatePrices(day === "review" ? reviewDate : null, area);
              ...
              <>
                ...
                {reviewError && (
                  <p className="text-red-400 text-sm">
                    Failed to load prices: {reviewError.message}
                  </p>
                )}
                {reviewData && (
                  <>
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                      {[
                        ...
                        {
                          label: "Avg (month)",
                          value: data.summary.month_avg_sek_kwh,
                        },
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-300">
                    Cost & Solar Simulator
                  </p>
                  <p className="text-xs text-gray-500">
                    Compare contracts, simulate solar PV revenue
                  </p>
                </div>
